 ...
 */
function initializeAnalytics(app, dynamicConfigPromisesList, measurementIdToAppId, installations, gtagCore, dataLayerName, options) {
    var _a;
    return tslib.__awaiter(this, void 0, void 0, function () {
...
function factory(app, installations, options) {
    ...
    initializationPromisesMap[appId] = initializeAnalytics(app, dynamicConfigPromisesList, measurementIdToAppId, installations, gtagCoreFunction, dataLayerName, options);
...
function getAnalytics(app$1) {
    ...
    return initializeAnalytics$1(app$1);
}
/**
 * Returns a Firebase Analytics instance for the given app.
 *
 ...
 * @param app - The FirebaseApp to use.
 */
function initializeAnalytics$1(app$1, options) {
...
exports.initializeAnalytics = initializeAnalytics$1;
